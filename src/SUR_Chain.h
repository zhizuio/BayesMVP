...
{ 
    ...
    public:
        ...
        SUR_Chain( std::shared_ptr<arma::mat> data_, std::shared_ptr<arma::mat> mrfG_, unsigned int nObservations_, 
            ...
            w_Sampler_Type w_sampler_type_ ,Beta_Type beta_type_ , Covariance_Type covariance_type_ , bool output_CPO = false , int maxThreads = 1, int tick = 1000,
        ...
        w_Sampler_Type getwSamplerType();
...
//        double logPGamma( const arma::umat& , double , double , const arma::mat& );
        ...
        double logLikelihood( const arma::mat& , const arma::mat& , const arma::mat& );
        ...
        void sampleZ( const arma::mat& , const arma::mat& , const arma::mat& );
        void sampleZ();
